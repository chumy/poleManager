...
<div class="flex flex-col">
    <div class="shadow overflow-hidden sm:rounded-lg bg-gray-800 ">
        <div class="grid grid-cols-1 sm:grid-cols-6 bg-gray-800 text-xs uppercase font-medium text-gray-400">
            ...
            <div class="hidden sm:grid place-items-center px-5 py-3  tracking-wider {{($loop->odd) ? 'bg-black bg-opacity-20' :'' }} pl-4 text-center">
                <img class="object-cover h-6 " src=" {{ asset($user->inscripcion($campeonato)->first()->coche()->first()->imagen)}} " alt="" loading="lazy" />
            </div>
